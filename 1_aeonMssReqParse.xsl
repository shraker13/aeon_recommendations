...
<xsl:stylesheet version="2.0" 
  ...
  <!-- 
This stylesheet takes the data from the exported xml file 'aeonMssReq.xml' and organizes requests by a specified collection interest. It outputs a new xml document, 'aeonMssParsed.xml' 
